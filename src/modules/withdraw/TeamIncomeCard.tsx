// ✅ File 2: app/(your-path)/checkout/components/TeamIncomeCard.tsx
"use client";
            ...
            render={({ field }) => (
              <div className="mt-4 grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className={`p-4 rounded-xl border font-bold transition ${
                    field.value === "send" ? "border-black bg-white text-black" : "border-2 border-white/20 text-white bg-transparent"
                  }`}
                >
                      Send
                </button>
            ...
            <Controller
              ...
              rules={{
                ...
                validate: (v) => {
                  ...
                  if (a > teamIncome) return "Insufficient balance.";
                  return true;
                },
              }}
              render={({ field }) => (
