...
export interface HistoryItem {
  ...
  amount: number;
  status: string;
  type: "myIncome" | "teamIncome" | "shareIncome" | "binaryIncome";
}
            ...
            <Controller
              ...
              rules={{
                ...
                validate: (v) => {
                  ...
                  if (a > binaryIncome) return "Insufficient balance.";
                  return true;
                },
              }}
              render={({ field }) => (
...
export default BinaryIncomeCard;
