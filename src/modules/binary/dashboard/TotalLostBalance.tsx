...
//     return (
//         <div className="flex items-center justify-between rounded-2xl p-4 sm:p-6 w-full mx-auto border-2 border-red-400 bg-gradient-to-r from-[#ff512f] to-[#f9d423] relative shadow-lg animate-pulse-opacity mt-4">
...
//                 <span>
//                     <IoGiftOutline className="bg-black rounded-full text-6xl p-3 text-yellow-400" />
//                 </span>
//             </div>
//             <style jsx>{`
